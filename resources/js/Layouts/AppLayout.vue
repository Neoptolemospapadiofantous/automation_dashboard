                    ...
                    <nav class="flex-1 space-y-5 overflow-y-auto px-3 py-4" @click="handleMobileNavClick">
                        ...
                        <div>
                            ...
                            <div class="space-y-0.5">
                                ...
                                <SidebarLink :href="route('suite.index')" active-pattern="suite.*">Suite</SidebarLink>
