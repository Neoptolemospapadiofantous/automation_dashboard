            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        ...
                        <div class="relative z-0 mt-1 border border-border-line rounded-none cursor-pointer">
                            <button
                            ...
                            >
                                <div :class="{'opacity-50': addTeamMemberForm.role && addTeamMemberForm.role != role.key}">
                                    ...
                                    <!-- Role Description -->
                                    <div class="mt-2 text-xs text-ink-dim text-start">
                                        {{ role.description }}
                                    </div>
                                </div>
                            </button>
                        ...
                        <div v-for="invitation in team.team_invitations" :key="invitation.id" class="flex items-center justify-between gap-2">
                            ...
                            <div class="flex shrink-0 items-center">
                                ...
                                <button
                                    ...
                                    class="cursor-pointer ms-6 text-sm text-state-bad-ink focus:outline-none"
                        ...
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between gap-2 border border-transparent border-b-border-line px-2 py-2 transition-colors hover:border-ink">
                            ...
                            <div class="flex shrink-0 items-center">
                                ...
                                <button
                                    ...
                                    class="cursor-pointer ms-6 text-sm text-state-bad-ink"
                    ...
                    <div class="relative z-0 mt-1 border border-border-line rounded-none cursor-pointer">
                        ...
                        >
                            <div :class="{'opacity-50': updateRoleForm.role && updateRoleForm.role !== role.key}">
                                ...
                                <!-- Role Description -->
                                <div class="mt-2 text-xs text-ink-dim">
                                    {{ role.description }}
                                </div>
                            </div>
                        </button>
