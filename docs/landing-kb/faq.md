...
It greets every visitor, takes the action your chosen role needs — qualify a
lead, answer a sales question, resolve a support ticket, walk a new user through
...
CRM, a custom auth gateway, your own LLM), or your own UI on top of the chat. The
off-the-shelf agent covers the standardisable 80% of use cases; we build the rest
— fixed scope, and you keep the code.

## Are we locked in?

No. The product is yours to trial and cancel anytime — no monthly minimums, no
